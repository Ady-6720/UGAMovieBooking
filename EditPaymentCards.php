...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        ...
        <a class="nav-link" href="Cart.php" style="text-decoration:none; margin-right: 2400px; margin-top: 5px">
        ...
        <div class="col-md-6">
            ...
            <form action="AddPaymentCard.php" method="post">
                <div class="mb-3">
                    ...
                    <select class="form-select" id="cardtype" name="cardtype" style="width: 420px">
            ...
            <div class="col-md-6">
                <h1 style="margin-bottom: 30px">Current Payment Cards</h1>
                <?php
                $host = "localhost";
                $database = "movies";
                $username = "root";
                ...
                while ($card = mysqli_fetch_assoc($result)) {
                    ?>
                    <div>
                        <p style="margin-top: 30px">Card Number: <?= $card['cardNumber']; ?></p>
